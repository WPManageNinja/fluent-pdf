...
class AvailableOptions
{
    ...
    public static function commonSettings()
    {
        return [
            [
                ...
                'component' => 'dropdown',
                'tab'       => 'tab2',
                'tips'      => __('select a pdf paper size', 'fluent-pdf'),
            ...
            [
                ...
                'tab'       => 'tab2',
                'tips'      => __('The font color will use in the PDF.', 'fluent-pdf'),
            ...
            [
                ...
                'tab'       => 'tab2',
                'tips'      => __('The accent color is used for the page, section titles and the border.',
                    'fluent-pdf'),
                'component' => 'color_picker'
            ],
            [
                'key'       => 'entry_view',
                'label'     => __('Entry view', 'fluent-pdf'),
                'tab'       => 'tab2',
                'component' => 'radio_choice',
                'options'   => [
                    'I' => __('View', 'fluent-pdf'),
                    'D' => __('Download', 'fluent-pdf')
                ]
            ],
            [
                'key'       => 'empty_fields',
                'label'     => __('Show empty fields', 'fluent-pdf'),
                'tab'       => 'tab2',
                'component' => 'radio_choice',
                'options'   => [
                    'yes' => __('Yes', 'fluent-pdf'),
                    'no'  => __('No', 'fluent-pdf')
                ]
            ],
            [
                'key'       => 'reverse_text',
                'label'     => __('Reverse text', 'fluent-pdf'),
                'tab'       => 'tab2',
                'tips'      => __('Script like Arabic and Hebrew are written right to left.', 'fluent-pdf'),
                'component' => 'radio_choice',
                'options'   => [
                    'yes' => __('Yes', 'fluent-pdf'),
                    'no'  => __('No', 'fluent-pdf')
    ...
    public static function getInstalledFonts()
    {
        ...
        return apply_filters('fluent/pdf_font_list', $fonts);
    }
}
